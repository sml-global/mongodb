...
| Cross-account S3 permissions | [Cross-Account S3 Permissions](references/cross-account-s3-permissions.md) | Detailed IAM policies, trust relationships, security controls for Boomi ELT cross-account S3 access (for AWS org admin review) |
