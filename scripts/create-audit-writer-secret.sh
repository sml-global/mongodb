...
echo ""
echo "The Boomi library can now resolve this with:"
echo "  BoomiAuditLogLibrary.resolveMongoUri([k8sSecretName: '$SECRET_NAME'])"
echo ""
echo "For local testing via port-forward, use --mongo-uri directly:"
echo "  --mongo-uri 'mongodb://${ADMIN_USER}:<password>@127.0.0.1:27017/${DB_NAME}?authSource=admin&directConnection=true'"
