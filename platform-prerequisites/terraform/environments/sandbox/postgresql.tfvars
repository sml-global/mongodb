# PostgreSQL Terraform Configuration — Sandbox (Production account as temporary sandbox)
# Account: 632674123947 (Production account; UAT 672172129937 reserved for Phase 3+)
aws_region          = "us-east-1"
expected_account_id = "632674123947"
environment         = "sandbox"
name_prefix         = "oms-sandbox-postgresql"
# Dummy values from Phase 2 platform_contract (plan validation only)
cnpg_backup_bucket_name          = "oms-sandbox-eks-cnpg-backup"
postgresql_operator_iam_role_arn = "arn:aws:iam::632674123947:role/oms-sandbox-eks-postgresql-operator"
