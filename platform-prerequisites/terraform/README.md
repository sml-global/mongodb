...
Defaults are aligned to the static dev overlay naming convention:
- `pbm_bucket_name = "sml-oms-mongodb-backup-dev"`
- `aws_region = "us-east-1"` (defined in `examples/dev/variables.tf`)
